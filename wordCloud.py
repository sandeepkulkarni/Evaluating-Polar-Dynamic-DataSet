...
if __name__ == '__main__':
    ...
    wordDict = {}
    count=0
    #Iterate through all the files listed in the directory
        ...
        try:
            if(file!=".DS_Store" and count < 3000):
                ...
                with open(inputPath+"/"+file, "r") as data_file:
                    ...
                    if "Language" in data:      #Count the number of occurences of each language present in the dataset
                        language = data["Language"].encode("ascii")
                        if language in wordDict:
                            wordDict[language]+=1
                        else:
                            wordDict[language]=1
                    if "SWEET" in data:         #Count the number of occurences of each SWEET concept and values in the dataset
                    ...
                    if "TIKA_NER" in data:      #Count the number of occurences of each NER entity present in the dataset
...
#Sort the items in descending order and retrieve the top 100 words to represent in the word cloud
